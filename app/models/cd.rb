class Cd < ApplicationRecord
  ...
  validates :stock,numericality: { only_integer: true,greater_than: 0,  message: "は自然数を入力してください"}
  validates :price,numericality: { only_integer: true,greater_than: 0, message: "は自然数を入力してください"}
